...
export default function SubnoteBlock({data, index} : any){
    // React hooks
    ...
    const notes = useSelector((state : any) => state.subnotes.notes.filter((note : any) => note._id === data.note)[0]) as any
